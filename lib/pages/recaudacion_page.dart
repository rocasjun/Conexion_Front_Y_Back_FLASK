      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final recaudacionesList =
            ...
            final inquilino = recaudacion.persona;
            final fecha = DateTime.parse(recaudacion.fechaOperacion);
            ...
            return Card(
              child: InkWell(
                onTap: () {
                  _navigateToDetailPage(recaudacion); // Navigate to the detail page
                },
                child: ListTile(
                  title: Text(
          ...
          /*// Filtrar las recaudaciones por el estado "Validado"
          final validadoRecaudaciones =
              specificMonthRecaudaciones.where((recaudacion) {
            return recaudacion.estadoRecaudacion.descripcion == "Validado";
          }).toList();

          // Count the number of validadoRecaudaciones
          //final validadoCount = validadoRecaudaciones.length;*/
