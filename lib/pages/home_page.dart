...
class _HomePageState extends State<HomePage> {
  final url = Uri.parse("http://127.0.0.1:5000/api/predios");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            predio.tipoPredio.nombrePredio,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: TextStyle(
                                              fontWeight: FontWeight.bold,
      ...
      bottomNavigationBar: BottomNavigationBar(
        backgroundColor: ColorConstant.blue800,
        type: BottomNavigationBarType.fixed, // Agregado
...
class ColorConstant {
  static const blue800 = Color(0xFF000080);
  static const whiteA700 = Color(0xFFFFFFFF);
}
