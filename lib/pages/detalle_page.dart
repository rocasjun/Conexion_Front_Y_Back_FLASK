...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String area = widget.recaudacion.reciboMantRecaudacion.casa.area;
    int numero = widget.recaudacion.reciboMantRecaudacion.casa.numero;
    double? participacion =
        widget.recaudacion.reciboMantRecaudacion.casa.participacion;
    int piso = widget.recaudacion.reciboMantRecaudacion.casa.piso;
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Suma de detalles del recibo: $sumaDetalles',
                            style: TextStyle(
                              fontSize: 16,
                              color: Colors.white,
                            ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Importe de la recaudación: $totalRecaudadoFormateado',
                            style: TextStyle(
                              fontSize: 16,
                              color: Colors.white,
                            ),
